...
#define STRING_CONFIG_H_AUTHOR "(viet3, default config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 20, 45 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 }
